...
@file:Suppress(
    "INVISIBLE_MEMBER", "INVISIBLE_REFERENCE", "EXPOSED_PARAMETER_TYPE"
...
fun renderComposableIntoBrowserViewport(
    ...
    ComposeWindow().apply {
        ...
        val htmlTitleElement = (htmlHeadElement.getElementsByTagName("title").item(0) ?: document.createElement("title")
            .also { htmlHeadElement.appendChild(it) }) as HTMLTitleElement
